...
```
Add-Book [-ISBN] <string> [-Title] <string> [[-PublishDate] <string>] [[-Publishers] <string>]
 [[-NumberOfPages] <int>] [[-CoverUrl] <string>] [[-FirstSentence] <string>] [[-ScannedAt] <string>]
...
Inserts book metadata into the Books table.
...
{{ Fill FirstSentence Description }}
