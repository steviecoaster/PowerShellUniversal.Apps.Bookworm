...
param(
    [string]$SourcePath = (Join-Path $PSScriptRoot '..\PowerShellUniversal.Apps.Bookworm'),
    [string]$TargetModulePath = 'C:\ProgramData\UniversalAutomation\Repository\Modules\PowerShellUniversal.Apps.Bookworm',
